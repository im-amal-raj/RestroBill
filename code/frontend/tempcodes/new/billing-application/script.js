...
function printInvoice() {
    ...
    const printWindow = window.open('', '', 'width=304,height=auto'); // 304px width equals 80mm
    printWindow.document.open();
    printWindow.document.write('<html><head><title>Invoice</title>');
    printWindow.document.write('<link rel="stylesheet" href="path/to/your/css/style.css">'); // Link to your CSS file
